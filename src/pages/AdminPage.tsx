...
import {
  loadAdminCatalog, loadAdminOrders, loadAdminReviews, saveAdminProduct,
  ...
  async function refresh() {
    try {
      const [nextProducts, nextOrders, nextReviews] = await Promise.all([
        loadAdminCatalog(), loadAdminOrders(), loadAdminReviews(),
      ]);
      setProducts(nextProducts); setOrders(nextOrders); setReviews(nextReviews); setStatus('');
    } catch (error) {
