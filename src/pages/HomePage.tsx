  ...
  return (
    <main>
      ...
      <section className="home-catalog section-wrap">
        <div className="section-heading"><div><p className="eyebrow">Сейчас в саду</p><h2>Ароматы, которые<br /><em>хочется носить</em></h2></div><Link className="text-link" to="/catalog">Весь каталог <ArrowRight size={16} /></Link></div>
      ...
      <section className="story-section section-wrap">
        ...
        <div className="story-numbers"><div><strong>4 000+</strong><span>читателей канала</span></div><div><strong>1 259</strong><span>публикаций изучено</span></div><div><strong>{products.length}</strong><span>ароматов в каталоге</span></div><div><strong>РФ + СНГ</strong><span>география доставки</span></div></div>
      </section>
