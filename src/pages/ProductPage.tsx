    ...
    <main className="product-page">
      ...
      <div className="product-detail">
        ...
        <div className="product-detail__copy">
          ...
          <div className="detail-actions"><button className="button" type="button" onClick={() => add(product.id)}><ShoppingBag size={17} />Добавить в корзину</button><a className="button button--outline" href="https://t.me/jardinmanager" target="_blank" rel="noreferrer">Заказать в Telegram</a></div>
