  ...
  return (
    <div className="site-shell">
      ...
      <footer className="site-footer" id="contacts">
        ...
        <div className="footer-bottom"><span>© {new Date().getFullYear()} Jardin Secret</span><span>Developed by <a href="https://t.me/verbdev" target="_blank" rel="noreferrer">@verbdev</a></span></div>
      </footer>
    </div>
  );
}
